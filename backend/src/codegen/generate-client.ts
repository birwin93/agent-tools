...
const listPath = `${apiPrefix}${routes.listDocs.path}`;
const getDocByIdPath = `${apiPrefix}${routes.getDocById.path}`;
const getDocBySlugPath = `${apiPrefix}${routes.getDocBySlug.path}`;
const createDocPath = `${apiPrefix}${routes.createDoc.path}`;
const updateDocPath = `${apiPrefix}${routes.updateDoc.path}`;
